...
- Push and synchronize events always use the ordinary Sonnet reviewer. A new deep
  review requires an explicit maintainer label action for the current revision.
