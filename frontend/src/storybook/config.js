...
export const storybookConfig = [
  ...
  },
  {
    ...
    pages: [
      ...
      { title: "Icons", path: "/ui-kit/icons", component: IconsPage, searchTerms: ["HomeIcon CalendarIcon CheckIcon SelectionCheckIcon ClockIcon AlertIcon ChatIcon FoodIcon TrainIcon ChevronLeftIcon ArrowRightIcon CrossIcon InfoIcon ChevronRightIcon иконки"] },
  ...
  },
  {
    ...
    pages: [
      ...
      { title: "Day Selector", path: "/aiwa/day-selector", component: DaySelectorPage, searchTerms: ["DayOverview DayWheel ScreenDayHeader день барабан дата"] },
