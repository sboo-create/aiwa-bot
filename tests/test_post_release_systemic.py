...
class PostReleaseSystemicTests(unittest.TestCase):
    ...
    def test_nested_immutable_asset_has_matching_cache_version(self):
        ...
        self.assertIn("main.js?v=r28", index)
        self.assertIn('import "./deslop-main-aiwa-v177.js?v=r28";', entry)
        self.assertIn(
            'import("./AiwaWebUiChart-aiwa-v177.js?v=r28")',
            bundle,
        )
        chart_bundle = (
        ...
        self.assertIn(
            'from "./deslop-main-aiwa-v177.js?v=r28";',
            chart_bundle,
        )
