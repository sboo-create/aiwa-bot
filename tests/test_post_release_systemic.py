...
class PostReleaseSystemicTests(unittest.TestCase):
    ...
    def test_nested_immutable_asset_has_matching_cache_version(self):
        ...
        self.assertIn("main.js?v=r31", index)
        self.assertIn('import "./deslop-main-aiwa-v177.js?v=r31";', entry)
        self.assertIn(
            'import("./AiwaWebUiChart-aiwa-v177.js?v=r31")',
            bundle,
        )
        chart_bundle = (
        ...
        self.assertIn(
            'from "./deslop-main-aiwa-v177.js?v=r31";',
            chart_bundle,
        )
