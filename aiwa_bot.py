...
# ---------- senders ----------
# Секция перенесена в aiwa.pushes (модульный монолит,
# см. docs/architecture/monolith-split-plan.md).
from aiwa.pushes import (need_onboard,
    _last_start,
    begin_onboard,
    _CARD_CACHE,
    _NEW_CARDS_ALL,
    ...
    _general_card_png,
    send_infographic,
    send_general_infographic,
    send_daily_infographic,
    send_training_card,
    _feature_on,
    _food_dynamic_section_on,
    ...
    _SUM_CACHE,
    _prune_day,
    _prepared_context_key,
    _summary_state_for_day,
    _summary_hint,
    _summary_key,
    _summary_pack,
    _summary_unpack,
    prepared_summary_clear,
    prepared_summary_get,
    _PREP_CLEANUP_DAY,
    prepared_summary_put,
    ...
    _VoiceMessageProxy,
    _VoiceUpdateProxy,
    _send_audio_fallback,
    _send_voice_reply,
    _safety_level,
    _feedback_sampled,
    _instrument_feedback_prompt,
    _register_feedback_prompt,
    _feedback_prompt_exists,
    _submit_feedback,
    send_answer,
    _send_summary_text,
    _delivery_summary_fallback,
    push_general,
    send_general,
    cycle_text_analysis,
    dispatch_intent,
...
# Секция перенесена в aiwa.memory (модульный монолит,
# см. docs/architecture/monolith-split-plan.md).
from aiwa.memory import (MEM_MAX,
    mem_all,
    mem_set,
    mem_delete,
    mem_text,
    ...
    schedule_daily,
    set_daily_time,
    _save_period_start_atomic,
    _save_period_end_atomic,
    db_mark_period,
    mark_period,
    think_llm,
    _BCtx,
...
# ---------- commands ----------
# Секция перенесена в aiwa.commands (модульный монолит,
# см. docs/architecture/monolith-split-plan.md).
from aiwa.commands import (start,
    today,
    id_cmd,
    calendar_cmd,
    menu,
...
# ---------- text ----------
# Секция перенесена в aiwa.chat_text (модульный монолит,
# см. docs/architecture/monolith-split-plan.md).
from aiwa.chat_text import (on_text,
    on_voice,
    food_card,
    on_photo,
    _on_photo_bounded,
...
# ---------- callbacks ----------
# Секция перенесена в aiwa.callbacks (модульный монолит,
# см. docs/architecture/monolith-split-plan.md).
from aiwa.callbacks import (on_cb,
    safe_edit,
    on_error,
    admin_alert,
    load_logger,
