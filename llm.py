...
def training_plan(st, profile=None):
    ...
    base = {
        "menstrual": {
            ...
            "why": "В дни кровотечения энергия часто ниже, а боль и слабость могут усиливаться от тяжёлой тренировки. Если самочувствие нормальное, лёгкое движение может уменьшить напряжение в пояснице и животе.",
            "options": [
                {"name": "Спокойная прогулка", "benefit": "улучшает кровоток и мягко снижает спазм", "how": "20-30 мин, темп разговорный"},
                {"name": "Растяжка спины и таза", "benefit": "снимает напряжение в пояснице и бёдрах", "how": "10-15 мин, без боли и рывков"},
                {"name": "Мягкая йога", "benefit": "помогает расслабить живот и дыхание", "how": "15-25 мин, без прыжков и сильного пресса"},
            ],
        ...
        "follicular": {
            ...
            "duration": "35-55 мин",
            "summary": "Хорошее окно для силовой, техники и бодрого кардио, если сон и самочувствие нормальные.",
            "why": "После месячных эстроген обычно растёт, поэтому у многих выше энергия, лучше настроение и легче переносится нагрузка. Можно тренироваться плотнее, но без резкого скачка объёма.",
            "options": [
                {"name": "Силовая тренировка", "benefit": "лучше заходит работа на мышцы и тонус", "how": "40-50 мин, ноги/спина/ягодицы, без отказа"},
                {"name": "Кардио умеренно-бодро", "benefit": "поддерживает выносливость и энергию", "how": "25-35 мин: дорожка, велосипед или эллипс"},
                {"name": "Пилатес или функциональная", "benefit": "укрепляет корпус, осанку и тазовое дно", "how": "35-45 мин, контролируемый темп"},
            ],
        ...
        "ovulation": {
            ...
            "duration": "30-50 мин",
            "summary": "Можно выбрать более энергичную тренировку, но разминка и техника сегодня особенно важны.",
            "why": "В овуляцию часто больше сил и драйва. При этом у части женщин тело ощущается более подвижным, поэтому прыжки и резкие движения лучше делать только после хорошей разминки.",
            "options": [
                {"name": "Силовая активнее обычного", "benefit": "использует пик энергии без перегруза", "how": "35-50 мин, техника важнее веса"},
                {"name": "Короткие интервалы", "benefit": "дают тонус и кардио-эффект без долгой сессии", "how": "10-15 мин основной части после разминки"},
                {"name": "Танцы, бокс или сайкл", "benefit": "подходит, если хочется динамики и хорошее самочувствие", "how": "30-45 мин, следить за дыханием"},
            ],
        ...
        "luteal": {
            ...
            "why": "Во второй половине цикла чаще появляются отёки, усталость, тяга к сладкому и раздражительность. Стабильная умеренная нагрузка помогает настроению и сну, но перегруз может усилить ПМС.",
            "options": [
                {"name": "Лёгкая силовая", "benefit": "сохраняет тонус без перегруза нервной системы", "how": "30-40 мин, меньше вес, спокойный темп"},
                {"name": "Быстрая ходьба", "benefit": "уменьшает отёки и тревожность", "how": "30-40 мин, ровный темп"},
                {"name": "Плавание, йога или пилатес", "benefit": "снимает напряжение и мягко разгружает тело", "how": "25-40 мин, без гонки за результатом"},
            ],
    ...
    if not base:
        base = {
            ...
            "why": "Ориентируйся на самочувствие, сон, боль и уровень энергии.",
            "options": [
                {"name": "Ходьба", "benefit": "мягко поддерживает энергию", "how": "20-30 мин"},
                {"name": "Растяжка", "benefit": "снимает напряжение", "how": "10-15 мин"},
                {"name": "Лёгкая силовая", "benefit": "поддерживает тонус", "how": "спокойный темп"},
            ],
    ...
    if phase == "luteal" and sub == "поздняя":
        ...
        base["options"] = [
            {"name": "Прогулка", "benefit": "уменьшает отёки и напряжение", "how": "30-40 мин"},
            {"name": "Пилатес", "benefit": "поддерживает тонус без перегруза", "how": "25-35 мин спокойно"},
            {"name": "Растяжка", "benefit": "расслабляет спину и таз", "how": "15-20 мин"},
        ]
