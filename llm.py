...
def answer_question(st, question, profile=None, history=None, usage=None):
    ...
    msgs.append({"role": "user", "content": (
        ...
        "Пиши живо и тепло, без воды и канцелярита. Целевой объём содержательного ответа 1800-3000 знаков; НЕ превышай 3000 знаков и ОБЯЗАТЕЛЬНО заверши мысль, не обрывай предложение на полуслове. Только русский, без markdown. "
    ...
    out = _call(msgs, max_tokens=900, temperature=0.35, usage=usage)
...
def general_answer(profile, mode, question, hint=None, history=None, usage=None):
    ...
    msgs.append({"role": "user", "content": (
        ...
        "Не здоровайся, если пользовательница не поздоровалась прямо сейчас. Если есть история диалога, отвечай как продолжение и учитывай предыдущие реплики. "
        "Пиши живо и тепло, без воды. Целевой объём содержательного ответа 1800-3000 знаков; НЕ превышай 3000 знаков и ОБЯЗАТЕЛЬНО заверши мысль, не обрывай на полуслове. Только русский, без markdown. "
