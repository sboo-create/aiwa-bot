...
def card_captions(mode, ctx, usage=None):
    ...
    prompt = ("Данные пользовательницы: " + (ctx or "нет данных") + "\n\n"
              ...
              "Пример хорошего про питание: «Аппетит растёт из-за прогестерона — тянет к углеводам, выбирай сложные» или «Гречка и печень: восполняем железо после месячных» — механизм плюс действие. Пример плохого: «Сбалансированное питание». "
