...
def proactive_compose(topic, data_note, usage=None):
    ...
    prompt = ("Ты AIWA — тёплый и точный ассистент по женскому здоровью. Составь ОДНО короткое проактивное сообщение "
              ...
              "Сделай личным и конкретным (используй данные), тёплым и по делу, максимум 300 знаков. Заверши конкретным предложением действия от Айвы (например: давай подберу ужин с белком; могу собрать тренировку под фазу; включим практику на 3 минуты), не задавай общих вопросов вроде как самочувствие сегодня и не пиши как тебе такая идея. "
