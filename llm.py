...
def general_training(profile, mode):
    base = {
        "meno": {"level": "Силовая + кардио", "duration": "30-45 мин",
                 "summary": "В менопаузе приоритет — мышцы и кости: силовая, ходьба и баланс.",
        ...
        "preg": {"level": "Мягкая активность", "duration": "20-30 мин",
                 "summary": "В беременности — умеренно и без перегрева: ходьба, плавание, мягкая сила по самочувствию.",
        ...
        "default": {"level": "По самочувствию", "duration": "20-40 мин",
                    "summary": "Опирайся на самочувствие: ходьба, растяжка, лёгкая силовая.",
