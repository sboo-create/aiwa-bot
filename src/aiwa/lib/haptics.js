...
export function hapticLight() {
  ...
  // The host owns Telegram initialization and deduplicates legacy callbacks.
  ...
  try {
    ...
    // Haptics are enhancement-only: old clients must keep every action working.
  }
}

/**
 * Cover every current and future button, cell and form control, including
 * portal content. Capture phase also catches components that stop bubbling.
 */
